...
public class AgileUtils {
     ...
     * @throws Exception
     */
    public static void updateList(IAdminList admlst, String name, String oldname, String desc) throws Exception{
        ...
        if("".equals(oldname) || oldname == null) { // 新增Product line
            IAgileList item = (IAgileList)list.addChild(name, "V"+StringUtils.getNumberByPrefix(String.valueOf(nodes.size()+1), 4));
